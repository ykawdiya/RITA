...
* Understanding of the `Google Translate API`  
  * A Clone is used that can be found here: https://github.com/ykawdiya/google-translate-api
...
* Use `gulp watch` during development for auto linting and building.  
  * A Clone is used that can be found here: https://github.com/ykawdiya/gulp-watch
