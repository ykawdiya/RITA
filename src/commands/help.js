...
const helpMessage = function(config, botname, param)
{
   ...
   helpSection({
      ...
      link: "<https://github.com/ykawdiya/Rita/wiki/Translate-by-Reacting>",
      icon: ":flag_white:",
      cmd: null,
      help: "react",
      args: null,
   ...
   helpSection({
      ...
      link: "<https://github.com/ykawdiya/Rita/wiki/Translate-Custom-Message>",
      icon: ":abc:",
      cmd: "this",
      help: "custom",
   ...
   helpSection({
      ...
      link: "<https://github.com/ykawdiya/Rita/wiki/Translate-Last-Message>",
   ...
   helpSection({
      ...
      link: "<https://github.com/ykawdiya/Rita/wiki/Translate-Channel-Automatic>",
      icon: ":hash:",
      cmd: "channel",
      help: "auto",
   ...
   helpSection({
      config: config,
      title: "Stats",
      link: "<https://github.com/ykawdiya/Rita/wiki/Get-Statistics>",
      icon: ":bar_chart:",
      cmd: "stats",
      help: "stats",
   ...
   helpSection({
      config: config,
      title: "Settings",
      link: "<https://github.com/ykawdiya/Rita/wiki/Settings>",
      icon: ":gear:",
      cmd: "settings",
      help: "settings",
   ...
   helpSection({
      config: config,
      title: "Misc. Settings",
      link: "<https://github.com/ykawdiya/Rita/wiki/Misc.-Commands>",
      icon: ":robot:",
      cmd: "misc",
      help: "misc",
      args: "",
   ...
   helpSection({
      config: config,
      title: "ReadMe",
      link: "<https://github.com/ykawdiya/Rita/blob/master/README.md>",
      icon: ":bookmark_tabs:",
      cmd: "readme",
      help: "readme",
      args: "",
   ...
   helpSection({
      ...
      link: "<https://github.com/ykawdiya/Rita/issues>",
   ...
   `> ( https://github.com/ykawdiya/RitaBot/blob/master/README.md ) \n\n` +
   `# If you need to update your bot's version you can do so here:\n` +
   `> ( https://github.com/ykawdiya/RitaBot#migration )\n\n` +
   ...
   `> ( https://github.com/ykawdiya/RitaBot/issues )\n\n` +
